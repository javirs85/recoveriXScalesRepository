...
public class UPDRSI : ScaleBase
{
	...
	public InfoItem InitialInfo { get; set; } = new InfoItem
	{
		Label= "Overview",
Text = @"
# Overview
...
",
	...
	public ComplexOptionsItem CognitiveImpairment { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem HallucinationsAndPsychosis { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem DepressedMood { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem AnxiousMood { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem Apathy { get; set; } = new ComplexOptionsItem
	{
		Label = "1.5 APATHY",
	...
	public ComplexOptionsItem DopamineDysregulationSyndrome { get; set; } = new ComplexOptionsItem
	{
	...
	public OptionsItem OptionsItem2 { get; set; } = new OptionsItem
	{
	...
	public ComplexOptionsItem SleepProblems { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem DaytimeSleepiness { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem PainAndOtherSensations { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem UrinaryProblems { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem ConstipationProblems { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem LightHeadednessOnStanding { get; set; } = new ComplexOptionsItem
	{
	...
	public ComplexOptionsItem Fatigue { get; set; } = new ComplexOptionsItem
	{
		Label = "1.13 FATIGUE",
